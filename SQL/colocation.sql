...
--
-- Hôte : db
-- Généré le : ven. 07 août 2026 à 10:25
...
CREATE DATABASE IF NOT EXISTS colocation_test;
USE colocation;
...
--
-- Déchargement des données de la table `creneau_visite`
--

INSERT INTO `creneau_visite` (`id_creneauVisite`, `date_visite`, `heure_debut`, `heure_fin`, `nb_personne_max`, `id_annonce`) VALUES
(1, '2026-08-27', '09:31:00', '13:34:00', 8, 14);
...
(2, 'Martin', 'sophie.martin@email.com', '123123', 'Propriétaire', 1, 999.99, 200.00, '1978-07-22', 'photos/profil/sophie_martin.jpg', 999.99, 'Sophie', '38000€', 2, 'colocataire', NULL),
...
(9, 'safi', 'sroheed@gmail.com', '$2y$10$3/DCjH0CJMtItkcDFU/R9O2UC49BNBDzzxvrTu/pFga/6MULuYK3C', 'Salarié', 0, 0.00, 0.00, '2026-07-02', 'uploads/profile_photos/user_9_1783514015.jpg', 112.00, 'rohid', '888', 3, 'colocataire', '2026-08-07 07:44:39'),
(10, 'said', 'issintyasaid@gmail.com', '$2y$10$VF.6NgLI.2TDOwQNW/5rgur4TsOZ5OKuZXtkL5FSUo.siI2ZDcRry', 'Salarié', 1, 0.00, 0.00, '2006-01-20', '', 555.00, 'issintya', '333', 3, 'colocataire', '2026-08-07 07:43:39'),
(11, 'labelle', 'lisettelabelle45@gmail.com', '$2y$10$/HIAqLsgnriEhqh78PkKhOcM67ZouSrVzfKQzK4b/TGw37kRuJvzi', 'Indépendant', 1, 0.00, 0.00, '2000-08-28', '', 450.00, 'lisette', '0', 3, 'propriétaire', '2026-08-07 08:21:35');
...
--
ALTER TABLE `creneau_visite`
  MODIFY `id_creneauVisite` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `liste_favoris`
  MODIFY `id_listeFavoris` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
