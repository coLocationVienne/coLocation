 ...
 <nav class="navbar bg-body-tertiary w-25">
  <div class="container-fluid">
    <form class="d-flex" role="search">
      <input class="form-control me-2" type="search" placeholder="localisation" aria-label="Search"/>
      <input class="form-control me-2" type="search" placeholder="prix cible" aria-label="Search"/>
      ...
      <section>
        ...
        <p>c'est des lieux de des lieux de vie sélectionnés 
